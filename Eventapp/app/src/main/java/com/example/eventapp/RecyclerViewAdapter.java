...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
    ...
    public RecyclerViewAdapter(List<SearchOutputClass> resultList, Context context) {
    ...
    public void onBindViewHolder(@NonNull @NotNull RecyclerViewAdapter.MyViewHolder holder, int position) {
        ...
        holder.heart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    mydata.put("Category", category_list);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                try {
                    mydata.put("Lat", latitude);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                try {
                    mydata.put("Lng", longitude);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
...
//                    Toast.makeText(context, sharedPreferencesName + " was removed from favorites", Toast.LENGTH_SHORT).show();
                    holder.heart.setImageDrawable(context.getResources().getDrawable(R.drawable.heart_outline_black));
...
//                    Toast.makeText(context, sharedPreferencesName + " was added to favorites", Toast.LENGTH_SHORT).show();
                    holder.heart.setImageDrawable(context.getResources().getDrawable(R.drawable.heart_fill_red));
